...
class Media{
    ...
    public static function InsertarVenta($id_Usuario,$id_Media,$cantidad){
        $objCon=new Conexion();
        $conexion=$objCon->GetConexion();
        $sentencia=$conexion->prepare('INSERT INTO ventas_medias (id_usuario,id_media,cantidad) VALUES (:id_usuario,:id_media,:cantidad)');
        
        $sentencia->bindValue(':id_usuario',$id_Usuario,PDO::PARAM_INT);
    ...
    public static function TraerVentas(){
        ...
        $objCon=new Conexion();
        $conexion=$objCon->GetConexion();
        $sentencia=$conexion->prepare('SELECT * FROM ventas_medias');
        $sentencia->execute();
